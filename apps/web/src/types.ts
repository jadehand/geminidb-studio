export type Connection = { id: string; name: string; mode: 'mock' | 'influx'; endpoint: string; username: string; password?: string; autoLogin: boolean; readOnly: boolean; insecureSkipVerify: boolean }
