...
export const bridge = {
  ...
  bulkJob: (id: string) => request<BulkJobStatus>(`/bulk-jobs/${encodeURIComponent(id)}`),
  resumeBulkJob: (id: string) => request<BulkJobStatus>(`/bulk-jobs/${encodeURIComponent(id)}/resume`, { method:'POST' }),
  cancelBulkJob: (id: string) => request<BulkJobStatus>(`/bulk-jobs/${encodeURIComponent(id)}/cancel`, { method:'POST' }),
